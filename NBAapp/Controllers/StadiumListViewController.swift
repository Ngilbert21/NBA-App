...
class StadiumListViewController: UIViewController {
    ...
    private var stadiumSelected: Stadium?
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destination = segue.destination as? StadiumDetailViewController {
            destination.stadium = stadiumSelected
        }
    }
